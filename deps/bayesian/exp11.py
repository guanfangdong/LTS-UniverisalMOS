...
#    print(sigma_vec.shape)
    ...
    avg_pro_pos = clr_pro_vec_pos[:, 0]*0.4 + clr_pro_vec_pos[:, 1]*0.2 + clr_pro_vec_pos[:, 2]*0.2
    avg_pro_pos = avg_pro_pos + spa_pro_vec_pos[:, 0]*0.1 + spa_pro_vec_pos[:, 1]*0.1
...
#    spa_pro_vec_pos[:, 0]*0.245 + spa_pro_vec_pos[:, 1]*0.245
    ...
    avg_pro_neg = avg_pro_neg + spa_pro_vec_neg[:, 0]*0.1 + spa_pro_vec_neg[:, 1]*0.1
