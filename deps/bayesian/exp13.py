...
#    sigma_vec = (torch.abs(sigma_vec_pos) + torch.abs(sigma_vec_neg))/2.0
    ...
    # avg_pro_neg = pro_vec_neg[:, 0]*0.6 + pro_vec_neg[:, 1]*0.15 + pro_vec_neg[:, 2]*0.15 + pro_vec_neg[:, 3]*0.15 + pro_vec_neg[:, 4]*0.15
    # avg_pro_pos = pro_vec_pos[:, 0]*0.6 + pro_vec_pos[:, 1]*0.15 + pro_vec_pos[:, 2]*0.15 + pro_vec_pos[:, 3]*0.15 + pro_vec_pos[:, 4]*0.15

    avg_pro_neg = pro_vec_neg[:, 0]*0.4 + pro_vec_neg[:, 1]*0.15 + pro_vec_neg[:, 2]*0.15 + pro_vec_neg[:, 3]*0.15 + pro_vec_neg[:, 4]*0.15
    avg_pro_pos = pro_vec_pos[:, 0]*0.4 + pro_vec_pos[:, 1]*0.15 + pro_vec_pos[:, 2]*0.15 + pro_vec_pos[:, 3]*0.15 + pro_vec_pos[:, 4]*0.15
