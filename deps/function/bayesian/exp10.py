...
#     print(ex_image.shape)
    ...
    dis_vec = dis_vec.permute(1, 0, 2)

    abs_dis_vec = torch.abs(dis_vec)


    mus_imgs_vec = imgs_vec.mean(dim = 2)

    residual_imgs_vec = torch.abs(imgs_vec.permute(2, 0, 1) - mus_imgs_vec).mean(dim = 0)
...
#
    ...
    residual_imgs_vec[residual_imgs_vec == 0] = 100000



    pro_dis_vec = 1 - 0.5*(abs_dis_vec.permute(1, 0, 2)/residual_imgs_vec)

    pro_dis_vec = pro_dis_vec.permute(1, 0, 2)
    ...
    pro_dis_vec = torch.cat((pro_dis_vec[:, 0:midpos, :], pro_dis_vec[:, midpos + 1:num_feats, :]), dim = 1)
    ...
    sum_pro_dis_vec = pro_dis_vec[:, :, 0]*0.4 + pro_dis_vec[:, :, 1]*0.1 + pro_dis_vec[:, :, 2]*0.1 + pro_dis_vec[:, :, 3]*0.1 + pro_dis_vec[:, :, 4]*0.1


#    int_pro_vec = sum_pro_dis_vec.mul(energy_vec)


    pos_pro_dis_vec = sum_pro_dis_vec.clone()
    neg_pro_dis_vec = sum_pro_dis_vec.clone()
...
#    pos_pro_dis_vec = int_pro_vec.clone()
#    neg_pro_dis_vec = int_pro_vec.clone()


    pos_pro_dis_vec[labs_vec == 0] = 0
    neg_pro_dis_vec[labs_vec == 255] = 0



    sum_pos_pro_dis_vec = pos_pro_dis_vec.sum(dim = 1)
    sum_neg_pro_dis_vec = neg_pro_dis_vec.sum(dim = 1)
    ...
    mean_pos_pro_dis_vec = sum_pos_pro_dis_vec/P1_num_nozero
    mean_neg_pro_dis_vec = sum_neg_pro_dis_vec/P0_num_nozero
    ...
    final_pos_pro = P1.mul(mean_pos_pro_dis_vec).mul(mean_pos_pro_energy)
    final_neg_pro = P0.mul(mean_neg_pro_dis_vec).mul(mean_neg_pro_energy)


#    final_pos_pro = final_pos_pro.sqrt().sqrt()
#    final_neg_pro = final_neg_pro.sqrt().sqrt()


#    final_pos_pro1 = (((mean_pos_pro_dis_vec.mul(mean_pos_pro_energy)).sqrt()).mul(P1)).sqrt()
#    final_neg_pro1 = (((mean_neg_pro_dis_vec.mul(mean_neg_pro_energy)).sqrt()).mul(P0)).sqrt()




    # avg_pro_neg = clr_pro_vec_neg[:, 0]*0.4 + clr_pro_vec_neg[:, 1]*0.2 + clr_pro_vec_neg[:, 2]*0.2
...
#     idx1 = x + y*432
#
#     print(pro_dis_vec.shape)
#     print(sum_pro_dis_vec.shape)
#     print(labs_vec.shape)
#
#     print("borderline ++++++++++++++++++++++++++++++++++++++++++++++")
#     print(labs_vec[idx1])
#     print(residual_imgs_vec[idx1])
#
#     print(pro_dis_vec[idx1])
#
#     print(energy_vec[idx1])
#
#     print(sum_pro_dis_vec[idx1])
#
#     print(energy_vec.shape)
#
#     print(sum_pro_dis_vec.shape)
#
#     print(pos_pro_dis_vec[idx1])
#     print(neg_pro_dis_vec[idx1])
#
#     print(pos_pro_energy[idx1])
#     print(neg_pro_energy[idx1])
#
#     print("borderline ---------------------------------------------")
#
#     print(P0_num[idx1])
#     print(P1_num[idx1])
#
#     print(sum_pos_pro_dis_vec[idx1])
#     print(sum_neg_pro_dis_vec[idx1])
#
#     print(mean_pos_pro_dis_vec[idx1])
#     print(mean_neg_pro_dis_vec[idx1])
#
#     print(mean_pos_pro_energy[idx1])
#     print(mean_neg_pro_energy[idx1])
#
#     print(P1[idx1])
#     print(P0[idx1])
#
#     print(final_pos_pro[idx1])
#     print(final_neg_pro[idx1])
#
#
#
#
...
#    re_labs = (P1_X > rate*P0_X)*255
    re_labs = (final_pos_pro > rate*final_neg_pro)*255
